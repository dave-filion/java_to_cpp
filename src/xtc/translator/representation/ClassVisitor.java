...
public class ClassVisitor extends Visitor implements Cloneable{
	...
	//private ConstructorVisitor constructor;
    ...
    //if after all of this ^^^ and we haven't assigned an extension, the class extends object
	...
	/**
	 * This was a really inelegant solution to getting extensions
   * I changed it a bit 
	 */
    ...
    public String toString() {
        return "ClassVisitor identifier = " + identifier + "\nextension="
                + extensions.toString() + "\nsuperClass=" + superClass.identifier + ", modifiers="
                + modifiers + "\nFieldList="
    ...
    /*
    public ConstructorVisitor getConstructor() {
        return constructor;
    }
